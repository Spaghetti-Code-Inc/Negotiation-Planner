...
import 'multi_thumb_slider_state.dart';
import 'thumb_lock_behaviour.dart';
import 'thumb_overdrag_behaviour.dart';
...
class MultiThumbSlider extends StatefulWidget {
  ...
  final Widget Function(BuildContext context, int index, double value)? thumbBuilder;
